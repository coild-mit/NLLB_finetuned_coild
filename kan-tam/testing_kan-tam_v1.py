...
MODEL_PATH = "/home/coild/NLLB/Output/Finetuning/Kan-Tam"
...
TEST_SOURCE_FILE = "/home/coild/NLLB/TestData/Kannada.txt"
TEST_TARGET_FILE = "/home/coild/NLLB/TestData/Tamil.txt"

# Output Filenames
OUTPUT_EXCEL = "/home/coild/NLLB/Output/Testing/Kan-Tam/finalbenchmark_results_kan-tam.xlsx"
OUTPUT_TEXT = "/home/coild/NLLB/Output/Testing/Kan-Tam/finalbenchmark_results_kan-tam.txt"
SCORES_FILE = "/home/coild/NLLB/Output/Testing/Kan-Tam/final_score_report.txt"
...
df = pd.DataFrame({
    "Source (Kannada)": sources,
    "Target (Tamil)": references,
