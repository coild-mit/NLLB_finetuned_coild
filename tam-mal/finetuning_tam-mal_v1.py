...
SOURCE_FILE = "/home/coild/NLLB/TrainingData/tam-mal/Tamil.txt"
TARGET_FILE = "/home/coild/NLLB/TrainingData/tam-mal/Malayalam.txt"
OUTPUT_DIR = "/home/coild/NLLB/Output/Finetuning/Tam-Mal"
...
# 6. Start Fine-tuning
print(f"Starting Tamil-to-Malayalam fine-tuning...")
trainer.train()

# 7. Save Final (Best) Model
trainer.save_model(OUTPUT_DIR)
print(f"Training finished. Best Tamil-Malayalam model saved to {OUTPUT_DIR}")
